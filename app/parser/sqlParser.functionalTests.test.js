...
describe(SqlParser.name, () => {
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE WHERE CLAUSE COLUMN = 'STRING' should pass functionnal test 17", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE WHERE CLAUSE 'STRING' = COLUMN should pass functionnal test 18", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE WHERE CLAUSE COLUMN1 = COLUMN2 should pass functionnal test 19", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE WHERE CLAUSE 'string' = 'string' should pass functionnal test 20", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE QUERY WITH WHERE CLAUSE = COLUMN EQUAL STRING PRESENT IN COLUMN should pass functionnal test 22", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE QUERY WITH WHERE CLAUSE = COLUMN EQUAL NUMBER PRESENT IN COLUMN should pass functionnal test 23", () => {
    //ARRANGE
 ...
 describe(SqlParser.name, () => {
  it("JOIN WITH KEYWORD DIFFERENT FROM should pass functionnal test 27", () => {
    //ARRANGE
    const query = "select * from people join order on people.id != order.userId";
    const tablesObj = structuredClone(testingData);
 ...
 describe(SqlParser.name, () => {
  it("LIMIT TEST WITH WHERE CLAUSE should pass functionnal test 29", () => {
    //ARRANGE
