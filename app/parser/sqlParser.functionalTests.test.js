...
describe(SqlParser.name, () => {
  it("LEFT JOIN -- 5", () => {
    //ARRANGE
    const tablesObj = structuredClone(testingData);
    const query = "SELECT o.product o.amount p.firstName j1.occupation s1.salary m.firstName m.lastName j2.occupation FROM commamde AS o LEFT JOIN people AS p on o.userId = p.id LEFT JOIN people AS m on p.idManager = m.id LEFT JOIN job AS j1 on p.jobId = j1.id LEFT JOIN job AS j2 on m.jobId = j2.id LEFT JOIN salary AS s1 on j1.idSalary = s1.id LEFT JOIN salary AS s2 on j2.idSalary = s2.id";

    //ACT
    const result = JSON.stringify(SqlParser(query, tablesObj));

    //ASSERT
    expect(result).toBe('{"table":[["o.product","o.amount","p.firstName","j1.occupation","s1.salary","m.firstName","m.lastName","j2.occupation"],["Laptop","1200.00","John","Mason","10000","Jane","Doe","Plumber"],["Laptop","1200.00","","","","","",""],["Phone","800.00","Jane","Plumber","15000","","",""],["Mouse","25.50","John","Mason","10000","Jane","Doe","Plumber"],["Keyboard","45.00","Bob","Bouncer","20000","","",""],["Monitor","220.00","Cillian","Barman","10000","","",""],["Tablet","600.00","Jane","Plumber","15000","","",""],["Webcam","70.00","Bob","Bouncer","20000","","",""],["Desk Lamp","35.00","John","Mason","10000","Jane","Doe","Plumber"],["Chair","150.00","Cillian","Barman","10000","","",""],["USB Hub","20.00","John","Mason","10000","Jane","Doe","Plumber"],["External HDD","90.00","Jane","Plumber","15000","","",""],["Microphone","130.00","Bob","Bouncer","20000","","",""],["Graphics Tablet","340.00","Cillian","Barman","10000","","",""],["SSD","110.00","John","Mason","10000","Jane","Doe","Plumber"],["Router","75.00","Jane","Plumber","15000","","",""],["Power Supply","95.00","Jobless","Mason","10000","","",""],["RAM","60.00","Alice","Plumber","15000","Jane","Doe","Plumber"],["Desk","300.00","Charlie","Bouncer","20000","Bob","Dylan","Bouncer"],["Office Chair","250.00","Emily","Barman","10000","Jane","Doe","Plumber"],["Notebook","3.00","George","Mason","10000","John","Doe","Mason"],["Pen Pack","5.00","Hannah","Plumber","15000","Jane","Doe","Plumber"],["Drawing Tablet","400.00","Ivan","Bouncer","20000","Bob","Dylan","Bouncer"],["Headphones","150.00","Julia","Barman","10000","Cillian","Murphy","Barman"],["Webcam","80.00","Kevin","Mason","10000","John","Doe","Mason"],["Laptop Stand","50.00","Laura","Plumber","15000","Jane","Doe","Plumber"],["Micro SD Card","20.00","Michael","Bouncer","20000","Bob","Dylan","Bouncer"],["Portable Monitor","180.00","Nina","Barman","10000","Cillian","Murphy","Barman"],["Gaming Mouse","65.00","Oscar","Mason","10000","John","Doe","Mason"],["Mechanical Keyboard","130.00","Paul","Plumber","15000","Jane","Doe","Plumber"],["Smartwatch","210.00","Queen","Bouncer","20000","Bob","Dylan","Bouncer"],["Router","85.00","Rachel","Barman","10000","Cillian","Murphy","Barman"],["Cable Organizer","15.00","John","Mason","10000","Jane","Doe","Plumber"],["Flash Drive","12.00","Jane","Plumber","15000","","",""],["Bluetooth Speaker","90.00","Bob","Bouncer","20000","","",""],["Laptop Bag","70.00","Cillian","Barman","10000","","",""]],"tableName":"o-p-m-j1-j2-s1-s2-filtered"}')
  }) 
})
 ...
 describe(SqlParser.name, () => {
  it("COLUMNSHEADERSALIASES -- 7", () => {
    ...
    //ASSERT
    expect(result).toBe('{"table":[["product_bought","price","client_firstname","client_job","client_salary","manager_firstname","manager_lastname","manager_job"],["Laptop","1200.00","John","Mason","10000","Jane","Doe","Plumber"],["Laptop","1200.00","","","","","",""],["Phone","800.00","Jane","Plumber","15000","","",""],["Mouse","25.50","John","Mason","10000","Jane","Doe","Plumber"],["Keyboard","45.00","Bob","Bouncer","20000","","",""],["Monitor","220.00","Cillian","Barman","10000","","",""],["Tablet","600.00","Jane","Plumber","15000","","",""],["Webcam","70.00","Bob","Bouncer","20000","","",""],["Desk Lamp","35.00","John","Mason","10000","Jane","Doe","Plumber"],["Chair","150.00","Cillian","Barman","10000","","",""],["USB Hub","20.00","John","Mason","10000","Jane","Doe","Plumber"],["External HDD","90.00","Jane","Plumber","15000","","",""],["Microphone","130.00","Bob","Bouncer","20000","","",""],["Graphics Tablet","340.00","Cillian","Barman","10000","","",""],["SSD","110.00","John","Mason","10000","Jane","Doe","Plumber"],["Router","75.00","Jane","Plumber","15000","","",""],["Power Supply","95.00","Jobless","Mason","10000","","",""],["RAM","60.00","Alice","Plumber","15000","Jane","Doe","Plumber"],["Desk","300.00","Charlie","Bouncer","20000","Bob","Dylan","Bouncer"],["Office Chair","250.00","Emily","Barman","10000","Jane","Doe","Plumber"],["Notebook","3.00","George","Mason","10000","John","Doe","Mason"],["Pen Pack","5.00","Hannah","Plumber","15000","Jane","Doe","Plumber"],["Drawing Tablet","400.00","Ivan","Bouncer","20000","Bob","Dylan","Bouncer"],["Headphones","150.00","Julia","Barman","10000","Cillian","Murphy","Barman"],["Webcam","80.00","Kevin","Mason","10000","John","Doe","Mason"],["Laptop Stand","50.00","Laura","Plumber","15000","Jane","Doe","Plumber"],["Micro SD Card","20.00","Michael","Bouncer","20000","Bob","Dylan","Bouncer"],["Portable Monitor","180.00","Nina","Barman","10000","Cillian","Murphy","Barman"],["Gaming Mouse","65.00","Oscar","Mason","10000","John","Doe","Mason"],["Mechanical Keyboard","130.00","Paul","Plumber","15000","Jane","Doe","Plumber"],["Smartwatch","210.00","Queen","Bouncer","20000","Bob","Dylan","Bouncer"],["Router","85.00","Rachel","Barman","10000","Cillian","Murphy","Barman"],["Cable Organizer","15.00","John","Mason","10000","Jane","Doe","Plumber"],["Flash Drive","12.00","Jane","Plumber","15000","","",""],["Bluetooth Speaker","90.00","Bob","Bouncer","20000","","",""],["Laptop Bag","70.00","Cillian","Barman","10000","","",""]],"tableName":"o-p-m-j1-j2-s1-s2-filtered"}')
  }) 
})
 ...
 describe(SqlParser.name, () => {
  it("INNER JOIN -- 8", () => {
    //ARRANGE
    const query = "SELECT o.product AS product_bought o.amount AS price p.firstName AS client_firstname j1.occupation AS client_job s1.salary AS client_salary m.firstName AS manager_firstname m.lastName AS manager_lastname j2.occupation AS manager_job FROM commamde AS o INNER JOIN people AS p on o.userId = p.id LEFT JOIN people AS m on p.idManager = m.id LEFT JOIN job AS j1 on p.jobId = j1.id LEFT JOIN job AS j2 on m.jobId = j2.id LEFT JOIN salary AS s1 on j1.idSalary = s1.id LEFT JOIN salary AS s2 on j2.idSalary = s2.id";
    const tablesObj = structuredClone(testingData);
 ...
 describe(SqlParser.name, () => {
  it("SIMPLE WHERE CLAUSE COLUMN = 'STRING' -- 17", () => {
    ...
    //ASSERT
    expect(result).toBe('{"table":[["id","firstName","lastName","jobId","idManager"],["1","John","Doe","1","2"],["2","Jane","Doe","2",""]],"tableName":"people-filtered"}')
  }) 
})
 ...
 describe(SqlParser.name, () => {
  it("JOIN WITH KEYWORD DIFFERENT FROM -- 27", () => {
    //ARRANGE
    const query = "select * from people join commamde on people.id != commamde.userId";
    const tablesObj = structuredClone(testingData);
 ...
 describe(SqlParser.name, () => {
  it("LIMIT TEST -- 28", () => {
    ...
    //ASSERT
    expect(result).toBe('{"table":[["id","firstName","lastName","jobId","idManager"],["1","John","Doe","1","2"],["2","Jane","Doe","2",""],["3","Bob","Dylan","3",""]],"tableName":"people-filtered"}')
  }) 
})
 ...
 describe(SqlParser.name, () => {
  it("WHERE CLAUSE WITH ORDER BY -- 30", () => {
    //ARRANGE
    ...
    //ASSERT
    expect(result).toBe('{"table":[["id","firstName","lastName","jobId","idManager"],["10","Hannah","Adams","2","2"],["9","George","Clark","1","1"],["8","Emily","Jones","4","2"],["7","Charlie","Brown","3","3"],["6","Alice","Smith","2","2"]],"tableName":"people-filtered"}')
  }) 
})

 describe(SqlParser.name, () => {
  it("WHERE CLAUSE WITH ORDER BY AND LIMIT -- 31", () => {
    //ARRANGE
